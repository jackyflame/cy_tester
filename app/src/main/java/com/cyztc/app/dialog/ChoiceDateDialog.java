...
/**
 * Created by YWL on 2017/2/19.
 */

public class ChoiceDateDialog extends BaseDialog{
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_choice_date_layout);
