 ...
 */
public class ServiceTypeMeetDialog extends BaseDialog{
    ...
    public ServiceTypeMeetDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialot_meet_service_type_layout);
