...
public class SealApplyActivity extends BaseActivity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seal_apply_layout);
    ...
    public void onClickTextMenu() {
        ...
        String usenum = etUseNum.getText().toString().trim();
        ...
        employeeApplyBean.setType(3);
        employeeApplyBean.setSubType(CommonUtil.getApplySealType(type));
        employeeApplyBean.setCount(Integer.parseInt(usenum));
    ...
    {
        Intent intent = new Intent(context, SealApplyActivity.class);
