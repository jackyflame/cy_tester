...
public class LeaveApplyActivity extends BaseActivity{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leave_apply_layout);
    ...
    public void onClickTextMenu() {
        ...
        employeeApplyBean.setType(1);
        employeeApplyBean.setSubType(CommonUtil.getApplyLeavetype(type));
