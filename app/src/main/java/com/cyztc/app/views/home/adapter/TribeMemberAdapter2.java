...
public class TribeMemberAdapter2 extends BaseDataAdapter{

    public TribeMemberAdapter2(Context context, List<? extends BaseBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            convertView = mlayoutInflate.inflate(R.layout.item_tribe_member_layout2, parent, false);
        ...
        viewHolder.tvName.setText(tribeMemberBean.getStudentName());
