...
public class SslContextFactory {
  ...
  public static String TRUST_CA_PWD = "";
  public static String SELF_CERT_PWD = "";
  ...
  public static SSLSocketFactory getSSLSocketFactoryForTwoWay(Context context) {
    try {
      InputStream certificate = context.getResources().openRawResource(R.raw.cyssl);
      ...
      clientKeyStore.load(context.getResources().openRawResource(R.raw.cyssl),
